...
public interface MonitorUpdateService {

    Response updateGrafanaInfoUrl(UpdateGrafanaConfigUrlRequest updateGrafanaConfigUrlRequest, HttpSession session) throws Exception;

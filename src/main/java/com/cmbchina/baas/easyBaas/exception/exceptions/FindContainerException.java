...
public class FindContainerException extends RuntimeException {
    private String code;
    private HttpStatus httpStatus;

    public FindContainerException(final ErrorCodes errorCodes) {
        super(errorCodes.getMessage());
        this.code = errorCodes.getCode();
        this.httpStatus = errorCodes.getHttpStatus();
    }

    public FindContainerException(final String message) {
        super(message);
    }
}

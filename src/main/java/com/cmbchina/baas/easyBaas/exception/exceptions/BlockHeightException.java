...
public class BlockHeightException extends RuntimeException {
    private String code;
    private HttpStatus httpStatus;

    public BlockHeightException(final ErrorCodes errorCodes) {
        super(errorCodes.getMessage());
        this.code = errorCodes.getCode();
        this.httpStatus = errorCodes.getHttpStatus();
    }

    public BlockHeightException(final String message) {
        super(message);
    }
}

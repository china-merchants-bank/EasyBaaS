...
@Getter
public class IsNotHaveTelnetException extends RuntimeException {

    private String code;
    private HttpStatus httpStatus;

    public IsNotHaveTelnetException(final ErrorCodes errorCodes) {
        super(errorCodes.getMessage());
        this.code = errorCodes.getCode();
        this.httpStatus = errorCodes.getHttpStatus();
    }

    public IsNotHaveTelnetException(final String message) {
        super(message);
    }
}
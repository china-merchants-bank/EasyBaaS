...
public class GetBlockHeightException extends RuntimeException {
    private String code;
    private HttpStatus httpStatus;

    public GetBlockHeightException(final ErrorCodes errorCodes) {
        super(errorCodes.getMessage());
        this.code = errorCodes.getCode();
        this.httpStatus = errorCodes.getHttpStatus();
    }

    public GetBlockHeightException(final String message) {
        super(message);
    }
}

...
public class ChainVerionIsNewException extends RuntimeException {
    private String code;
    private HttpStatus httpStatus;

    public ChainVerionIsNewException(final ErrorCodes errorCodes) {
        super(errorCodes.getMessage());
        this.code = errorCodes.getCode();
        this.httpStatus = errorCodes.getHttpStatus();
    }

    public ChainVerionIsNewException(final String message) {
        super(message);
    }
}

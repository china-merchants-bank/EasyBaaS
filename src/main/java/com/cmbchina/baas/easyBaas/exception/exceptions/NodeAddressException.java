...
@Getter
public class NodeAddressException extends RuntimeException {

    private String code;
    private HttpStatus httpStatus;

    public NodeAddressException(final ErrorCodes errorCodes) {
        super(errorCodes.getMessage());
        this.code = errorCodes.getCode();
        this.httpStatus = errorCodes.getHttpStatus();
    }

    public NodeAddressException(final String message) {
        super(message);
    }
}
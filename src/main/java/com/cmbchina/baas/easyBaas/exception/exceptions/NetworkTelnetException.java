...
public class NetworkTelnetException extends RuntimeException {
    private String code;
    private HttpStatus httpStatus;

    public NetworkTelnetException(final ErrorCodes errorCodes) {
        super(errorCodes.getMessage());
        this.code = errorCodes.getCode();
        this.httpStatus = errorCodes.getHttpStatus();
    }

    public NetworkTelnetException(final String message) {
        super(message);
    }
}

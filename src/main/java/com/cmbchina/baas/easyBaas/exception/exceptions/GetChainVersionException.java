...
public class GetChainVersionException extends RuntimeException {
    private String code;
    private HttpStatus httpStatus;

    public GetChainVersionException(final ErrorCodes errorCodes) {
        super(errorCodes.getMessage());
        this.code = errorCodes.getCode();
        this.httpStatus = errorCodes.getHttpStatus();
    }

    public GetChainVersionException(final String message) {
        super(message);
    }
}

...
public class NoLoginShellUserException extends RuntimeException {
    private String code;
    private HttpStatus httpStatus;

    public NoLoginShellUserException(final ErrorCodes errorCodes) {
        super(errorCodes.getMessage());
        this.code = errorCodes.getCode();
        this.httpStatus = errorCodes.getHttpStatus();
    }

    public NoLoginShellUserException(final String message) {
        super(message);
    }
}
